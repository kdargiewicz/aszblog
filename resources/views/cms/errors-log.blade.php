            ...
            <div class="w3-row">
                <div class="w3-responsive">
                    <div class="w3-row w3-border-bottom w3-padding w3-light-grey w3-hide-small w3-hide-medium">
                        ...
                        <div class="w3-col l3"><b>URL</b></div>
                    ...
                    @foreach($errors as $error)
                        <a href="{{ route('error.show', $error->id) }}"
                           ...
                           style="text-decoration: none; color: inherit; display: block; cursor: pointer;">
                            ...
                            <div class="w3-col l3 w3-small">{{ Str::limit($error->url, 50) }}</div>
                            <div class="w3-col l2 w3-small">{{ Str::limit($error->file, 50) }}</div>
                            <div class="w3-col l1">{{ $error->line ?? '-' }}</div>
